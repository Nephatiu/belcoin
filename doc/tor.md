...
1. Run belcoin behind a Tor proxy
---------------------------------
...
In a typical situation, this suffices to run behind a Tor proxy:
	...
	./belcoin -proxy=127.0.0.1:9050


2. Run a belcoin hidden server
------------------------------
...
config file):
	...
	HiddenServiceDir /var/lib/tor/belcoin-service/
	HiddenServicePort 7777 127.0.0.1:7777
	HiddenServicePort 17777 127.0.0.1:17777

The directory can be different of course, but (both) port numbers should be equal to
your belcoind's P2P listen port (7777 by default, 17777 by default for testnet).

	-externalip=X   You can tell belcoin about its publicly reachable address using
	                this option, and this can be a .onion address. Given the above
	                configuration, you can find your onion address in
	                /var/lib/tor/belcoin-service/hostname. Onion addresses are given
...
In a typical situation, where you're only reachable via Tor, this should suffice:
	...
	./belcoind -proxy=127.0.0.1:9050 -externalip=youraddress.onion -listen
...
for normal IPv4/IPv6 communication, use:
	...
	./belcoin -onion=127.0.0.1:9050 -externalip=youraddress.onion -discover

Known addresses of belcoin nodes
