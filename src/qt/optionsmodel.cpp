...
void OptionsModel::Init()
{
    ...
    if (!settings.contains("strThirdPartyTxUrls")) {
        if(fTestNet)
            ...
            settings.setValue("strThirdPartyTxUrls", "https://bitinfocharts.com/belcoin/tx/%s|https://coinplorer.com/BEL/Transactions/%s|https://explorer.novaco.in/tx/%s|https://bchain.info/BEL/tx/%s");
    }
    strThirdPartyTxUrls = settings.value("strThirdPartyTxUrls", "https://bitinfocharts.com/belcoin/tx/%s|https://coinplorer.com/BEL/Transactions/%s|https://explorer.novaco.in/tx/%s|https://bchain.info/BEL/tx/%s").toString();
